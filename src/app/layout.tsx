        ...
        <header style={{ borderBottom: "1px solid #1a1a2e", background: "#09091a" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 56 }}>
            ...
            <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
              <Image src="/psaf.png" alt="PSAF" width={32} height={32} style={{ filter: "invert(1) sepia(1) saturate(2) hue-rotate(320deg) brightness(1.1)" }} />
        ...
        <footer style={{ borderTop: "1px solid #1a1a2e", marginTop: 80, padding: "24px 0" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <Image src="/psaf.png" alt="PSAF" width={18} height={18} style={{ filter: "invert(1) sepia(1) saturate(2) hue-rotate(320deg) brightness(1.1)", opacity: 0.5 }} />
